...
export function LoginForm() {
  ...
  return (
    <form className="panel mx-auto max-w-md space-y-5 p-8" onSubmit={handleSubmit}>
      <div>
        <h1 className="text-3xl font-bold text-slate-900">Welcome back</h1>
        <p className="mt-2 text-sm text-slate-500">Use your role-based account to continue.</p>
      </div>
